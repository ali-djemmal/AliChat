...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()== R.id.menuLogId){
            signOut();


        }
        if(item.getItemId()== R.id.menu_seting_id){
          Intent settingIntent = new Intent(MainActivity.this, Setting_Activity.class);
            startActivity(settingIntent);


        }
        if(item.getItemId()== R.id.menu_aalUser_id){
    ...
    private void setupViewPager(ViewPager viewPager){
        SectionspagerAdpter adpter = new SectionspagerAdpter(getSupportFragmentManager());
        adpter.AddFragment(new RequestsFragment() , "Requests");
        adpter.AddFragment(new Chat_Fragment(),"Chat");
        adpter.AddFragment(new Frendes_Fragment() ,"Frendes");
